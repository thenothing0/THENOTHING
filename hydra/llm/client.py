...
# backend -> (base_url, env var holding the api key, is_openai_wire)
_BACKENDS: Dict[str, tuple] = {
    "ollama": ("http://localhost:11434", "", False),
    "lmstudio": ("http://localhost:1234/v1", "", True),
    "openai-compat": ("", "OPENAI_API_KEY", True),
    ...
    "kimi": ("https://api.moonshot.cn/v1", "MOONSHOT_API_KEY", True),
}
...
def make_client(backend: str, model: str, *, base_url: str = "", api_key: str = "",
    ...
    default_url, env_var, openai_wire = _BACKENDS[key]
