...
WORKFLOWS: Dict[str, Dict[str, Any]] = {
    ...
    "osint_recon": {
        "name": "OSINT-First Reconnaissance",
        "description": "Passive OSINT → tech fingerprinting → heuristic-guided scan",
        "estimated_duration": "15 min",
        "phases": [
            {"phase": "osint_intel", "agent_type": "osint",
             "tools": [], "priority": 0},
            {"phase": "fingerprint", "agent_type": "recon",
             "tools": ["whatweb"], "priority": 1},
            {"phase": "pack_activation", "agent_type": "recon",
             "tools": [], "priority": 2},
            {"phase": "subdomain_enum", "agent_type": "recon",
             "tools": ["subfinder"], "priority": 2},
            {"phase": "http_probe", "agent_type": "recon",
             "tools": ["httpx"], "priority": 3},
            {"phase": "heuristic_scan", "agent_type": "vuln_research",
             "tools": ["nuclei"], "priority": 4},
        ],
        "nuclei_severity": "medium,high,critical",
        "max_concurrent": 4,
        "enable_osint": True,
    ...
    "cognitive_auto": {
        "name": "Cognitive Autonomous Pipeline (v6 Flagship)",
        "description": "Full cognitive loop: Observe → Understand → Reason → Simulate → Plan → Execute → Validate → Learn → Replan",
        "estimated_duration": "30-60 min",
        "phases": [
            {"phase": "observe", "agent_type": "cognitive",
             "tools": ["subfinder", "httpx", "whatweb"], "priority": 0,
             "subsystems": ["osint", "fingerprint", "temporal", "deception"]},
            {"phase": "understand", "agent_type": "cognitive",
             "tools": [], "priority": 1,
             "subsystems": ["cognitive_graph", "world_model"]},
            {"phase": "reason", "agent_type": "cognitive",
             "tools": [], "priority": 2,
             "subsystems": ["heuristics", "causal"]},
            {"phase": "simulate", "agent_type": "cognitive",
             "tools": [], "priority": 3,
             "subsystems": ["simulation"]},
            {"phase": "plan", "agent_type": "cognitive",
             "tools": [], "priority": 4,
             "subsystems": ["planner", "stealth"]},
            {"phase": "execute", "agent_type": "cognitive",
             "tools": ["nuclei", "sqlmap", "dalfox", "ffuf"], "priority": 5,
             "subsystems": ["stealth", "payload_engine"]},
            {"phase": "validate", "agent_type": "cognitive",
             "tools": [], "priority": 6,
             "subsystems": ["debate", "red_team_critic", "hallucination_defense"]},
            {"phase": "learn", "agent_type": "cognitive",
             "tools": [], "priority": 7,
             "subsystems": ["continuous_learning", "cognitive_graph"]},
            {"phase": "replan", "agent_type": "cognitive",
             "tools": [], "priority": 8,
             "subsystems": ["recon_expansion", "causal"]},
        ],
        "nuclei_severity": "medium,high,critical",
        "max_concurrent": 5,
    ...
    "bounty_hunt": {
        "name": "Autonomous Bounty Hunt (v7 Flagship)",
        "description": "Auto-discover programs → score → select targets → profile → cognitive_auto hunt → learn",
        "estimated_duration": "45-90 min",
        "phases": [
            {"phase": "discover", "agent_type": "bounty_hunter",
             "tools": [], "priority": 0,
             "subsystems": ["bounty_hunter"]},
            {"phase": "score", "agent_type": "bounty_hunter",
             "tools": [], "priority": 1,
             "subsystems": ["bounty_hunter"]},
            {"phase": "select", "agent_type": "bounty_hunter",
             "tools": [], "priority": 2,
             "subsystems": ["bounty_hunter", "researcher_profiles"]},
            {"phase": "profile", "agent_type": "cognitive",
             "tools": [], "priority": 3,
             "subsystems": ["researcher_profiles", "stealth"]},
            {"phase": "hunt", "agent_type": "cognitive",
             "tools": ["subfinder", "httpx", "nuclei", "katana"], "priority": 4,
             "subsystems": ["cognitive_loop", "simulation", "debate",
                            "guardrails", "audit"]},
            {"phase": "learn", "agent_type": "cognitive",
             "tools": [], "priority": 5,
             "subsystems": ["continuous_learning", "researcher_profiles"]},
        ],
        "nuclei_severity": "medium,high,critical",
        "max_concurrent": 5,
        "enable_cognitive_loop": True,
