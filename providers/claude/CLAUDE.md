# HYDRA / THENOTHING — Autonomous Security Swarm Platform

> **Claude Code (THENOTHING skills mode):** use the repository root `CLAUDE.md` as the authoritative operator brief (YAML skills under `skills/`, MCP-only execution, activation engine).
