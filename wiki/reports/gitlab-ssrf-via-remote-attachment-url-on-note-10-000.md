...
# GitLab — SSRF via remote_attachment_url on Note ($10,000)

> Reusable lesson distilled from a disclosed report — see the intel page [[gitlab-ssrf-via-remote-attachment-url-on-note-10-000-intel]].
...
## Related
- Intel: [[gitlab-ssrf-via-remote-attachment-url-on-note-10-000-intel]] · Target: [[gitlab]]
