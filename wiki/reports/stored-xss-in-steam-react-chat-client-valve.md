...
# Stored XSS in Steam React chat client — Valve

> Reusable lesson distilled from a disclosed report — see the intel page [[stored-xss-in-steam-react-chat-client-valve-intel]].
...
## Related
- Intel: [[stored-xss-in-steam-react-chat-client-valve-intel]] · Target: [[valve]]
