...
install_pip_tools() {
    ...
    pip3 install --quiet wafw00f dirsearch sqlmap 2>/dev/null || warn "Some pip tools failed"
...
verify() {
    ...
    local tools=("subfinder" "httpx" "nuclei" "ffuf" "amass" "katana" "gau" "nmap" "dalfox" "gxss" "dnsx" "hakrawler" "sqlmap")
    local ok=0
    local fail=0
